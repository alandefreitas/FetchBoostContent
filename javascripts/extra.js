...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let cmake_reference_links = Array.from(document.querySelectorAll('.md-typeset a[href*="cmake"]'));
    ...
    for (const link of cpp_reference_links.concat(open_std_links).concat(futures_reference_link).concat(cmake_reference_links)) {
        ...
        let is_code_reference = link.innerHTML.startsWith('std::') || link.href.includes('/futures/reference/') || link.href.includes('/cmake/help/')
